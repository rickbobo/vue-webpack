<template>
  <div class="right-container">
    ...
    <div class="invoice-make">
      ...
      <el-row class="invoice-make-content text-center" v-for="(invoiceRedDetail, index) in invoice.invoiceRedDetailVos" :key="index">
        <el-col :span="7">
          <div class="font-14">
            <template v-if="isNotBlank(invoiceRedDetail.name)">
              {{invoiceRedDetail.name}}
            </template>
            <template v-else>
              &ensp;
            </template>
        ...
        <el-col :span="2">
          <div class="font-14">
            <template v-if="isNotBlank(invoiceRedDetail.itemModel)">
              {{invoiceRedDetail.itemModel}}
            </template>
            <template v-else>
              &ensp;
            </template>
        ...
        <el-col :span="1">
          <div class="font-14">
            <template v-if="isNotBlank(invoiceRedDetail.unit)">
              {{invoiceRedDetail.unit}}
            </template>
            <template v-else>
              &ensp;
            </template>
        ...
        <el-col :span="3">
          <div class="font-14">
            <template v-if="isNotBlank(invoiceRedDetail.quantity)">
              {{invoiceRedDetail.quantity}}
            </template>
            <template v-else>
              &ensp;
            </template>
        ...
        <el-col :span="3">
          <div class="font-14">
            <template v-if="isNotBlank(invoiceRedDetail.unitPrice)">
              {{invoiceRedDetail.unitPrice | toFixed(8)}}
            </template>
            <template v-else>
              &ensp;
            </template>
        ...
        <el-col :span="3">
          <div class="font-14">
            <template v-if="isNotBlank(invoiceRedDetail.totalPrice)">
              {{invoiceRedDetail.totalPrice | toFixed(2)}}
            </template>
            <template v-else>
              &ensp;
            </template>
        ...
        <el-col :span="1">
          <div class="font-14">
            <template v-if="isNotBlank(invoiceRedDetail.taxRate)">
              {{invoiceRedDetail.taxRate * 100}}%
            </template>
            <template v-else>
              &ensp;
            </template>
        ...
        <el-col :span="4">
          <div class="font-14">
            <template v-if="isNotBlank(invoiceRedDetail.taxAmount)">
              {{invoiceRedDetail.taxAmount | toFixed(2)}}
            </template>
            <template v-else>
              &ensp;
            </template>
    ...
    <div class="mt-20 text-center">
      <router-link to="/query/invoiceQuery">
        <el-button type="primary" :loading="buttonLoading" @click.native.prevent="handleSaveInvoice">开 票</el-button>
...
<script>
  ...
  export default {
    ...
    created() {
      var state = JSON.parse(decodeURI(this.$route.params.state));
      this.originalInvoiceCode = state.originalInvoiceCode;
    ...
    methods: {
      ...
      handleSaveInvoice() {
        ...
        fetch.post('/invoiceRed/invoiceRed', util.stringify({
          originalInvoiceCode: this.originalInvoiceCode,
          originalInvoiceNo: this.originalInvoiceNo
        })).then(({msg}) => {
      ...
      handleGoBack() {
        ...
        this.$router.push('/invoice/redInvoiceMake');
      }
    },
    mounted() {
